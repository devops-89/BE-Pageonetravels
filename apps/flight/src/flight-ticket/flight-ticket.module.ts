...
import { FlightTicketController } from './flight-ticket.controller';
import { FlightTicketService } from './flight-ticket.service';
import { Booking, BookingRepositoryService, DBModule, FlightTicketRepositoryService, Order, OrderRepositoryService, Payment, User, UserRepositoryService } from '../../../../libs/database/src';
...
@Module({
    ...
    controllers: [FlightTicketController],
    providers: [FlightTicketService, GenerateTokenService,FlightTicketRepositoryService,Payment, Booking, Order, OrderRepositoryService, TransactionManager, HTTPSTboAPIService, RazorpayService,BookingRepositoryService,UserRepositoryService, JwtService, TokenValidationMiddleware],
})

...
export interface FLIGHTDATA {
  ...
  FLIGHT_GET_CANCELLATION_CHARGES: string
  FLIGHT_TICKET_FORLCC : string
  FLIGHT_BOOKING_DETAILS : string
  FLIGHT_CALENDER_DETAILS : string
  FLIGHT_RELEASE_PNR: string;
  FLIGHT_SEND_CHANGE_REQUEST: string;
  FLIGHT_GET_CHANGE_REQUEST: string;
  FLIGHT_CANCEL_TICKET : string;
  FLIGHT_PARTIAL_CANCELLATION : string;
  FLIGHT_BOOK_TICKET : string;
  FLIGHT_ROUND_BOOKING : string;

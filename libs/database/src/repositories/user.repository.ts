...
export class UserRepositoryService {
    ...
    //     try {
    //         const { email, password, status, roleName, permission, name, group, addedBy, guestUserId } = input;
    ...
    //     try {
    //         const user = await this.userRepository.findOne({ where: { email, verifyStatus: USER_VERIFY_STATUS.VERIFIED, is_email_verified: true }, loadRelationIds: true });
    ...
    //     try {
    //         const { countryCode, phoneNo, avatar, status, verifyStatus, id, permission, roleName, group, email, password, name, parent, is_email_verified, lastLogin } = input;
    ...
    //     try {
    //         const { userId, status, verifyStatus, is_email_verified, isPhoneNoVerified, password } = input;
    //         const updateFields = this.mapObject({ status, verifyStatus, is_email_verified, isPhoneNoVerified, password })
    ...
    //     try {
    //         const { userId, email, is_email_verified } = input;
    //         await this.userRepository.update(userId, { email, is_email_verified });
    //         return;
    //     } catch (error) {
    ...
    //     try {
    //         const { group, page, pageSize, status, parentId, search, isPhoneNoVerified, is_email_verified } = input;
    ...
    //             fields.is_email_verified = is_email_verified;
    //         }

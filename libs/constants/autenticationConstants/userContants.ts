...
export enum COMMISSION_TYPE{
    FLIGHT_ONEWAY_DOMESTIC =  "FLIGHT_ONEWAY_DOMESTIC",
    FLIGHT_ONEWAY_INTERNATIONAL =  "FLIGHT_ONEWAY_INTERNATIONAL",
    FLIGHT_ROUNDTRIP_DOMESTIC =  "FLIGHT_ROUNDTRIP_DOMESTIC",
    FLIGHT_ROUNDTRIP_INTERNATIONAL =  "FLIGHT_ROUNDTRIP_INTERNATIONAL",
    FLIGHT_MULTICITY_DOMESTIC =  "FLIGHT_MULTICITY_DOMESTIC",
    FLIGHT_MULTICITY_INTERNATIONAL =  "FLIGHT_MULTICITY_INTERNATIONAL",

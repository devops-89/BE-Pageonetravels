...
export const loginPasswordTemplate = function (password: string, email: string) {
                    ...
                    <td style="padding: 40px 0px 0px;">
                      ...
                      <div style="padding: 20px; background-color: rgb(255, 255, 255);">
                        <div style="color: rgb(0, 0, 0); text-align: left;">
                          <h1 style="margin: 1rem 0">Login credentials</h1>
                          <p style="padding-bottom: 16px">Please use the password below and your email to sign in:</p>
                          <p style="padding-bottom: 16px;padding-bottom: 0;">
                          <span style="text-align: left;display: block;">
                            Email: <strong
                              style="font-size: 130%">${email}</strong></span></p>
    ...
    const text = `
    Please use the password below and your email to sign in : ${password}`;
    return {
        html: html,
        text: text,
    };
